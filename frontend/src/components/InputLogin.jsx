...
const InputLogin = ({label, type, name, placeholder, isPassword = false, onChange, value}) => {
  ...
  return (
    <div className='login-card__input'>
      ...
      <div className='login-input__box'>
        <input className='login-page__input' type={inputType || "text"} placeholder={placeholder}
               name={name} onChange={onChange} value={value} required/>
